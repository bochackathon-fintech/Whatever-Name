...
class InformationsViewController: UIViewController {
    ...
    @IBAction func donateNowButtonAction(_ sender: Any) {
        let url = URL(string: "http://api.bocapi.net/v1/api/banks/bda8eb884efcef7082792d45/accounts/5dadbb4247773c3d9d819f7e/make-transaction")
        ...
        request.addValue("014711001175", forHTTPHeaderField: "Auth-Provider-Name")
        ...
        let jsonDict: [String: Any] = ["description": "string",
                                   ...
                                   "from": ["account_id":"5dadbb4247773c3d9d819f7e",
                                            "bank_id":"bda8eb884efcef7082792d45"],
                                   "to": ["account_id":"d058aa4367ebd75b4742f57b",
                                            "bank_id":"bda8eb884efcef7082792d45"],
                                   "value": ["currency":"EUR",
                                          "amount":value]]
